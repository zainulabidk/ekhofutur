  ...
  return (
    <SiteShell>
      ...
      <section className="section-padding">
        <div className="container-site space-y-10 md:space-y-12">
          <Reveal>
            <h2 className="heading-section">Venture details</h2>
            <p className="text-slate-500 font-medium mt-2 max-w-xl">
              In-depth information for each service — use pagination to browse ventures.
            </p>
          </Reveal>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {otherVentures.map((venture, idx) => (
                <Reveal
                  key={venture.id}
                  delay={idx * 30}
                  className="bg-white rounded-2xl border border-slate-100 hover:shadow-md transition-shadow overflow-hidden h-full flex flex-col"
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <Link href={venture.href} className="btn-primary text-[9px] py-3 px-6 w-fit">
                      Explore
                    </Link>
                  </div>
                </Reveal>
